...
function generatePushManifestEntryForUrl(analyzer, url, ignoreUrls) {
    return __awaiter(this, void 0, void 0, function* () {
        const analyzedDocument = yield analyzer.analyze(url);
        const analyzedImports = analyzedDocument.getByKind('import', { externalPackages: true, imported: true });
...
class AddPushManifest extends stream_1.Transform {
    constructor(config, filePath) {
        ...
        this.files = new Map();
        this.config = config;
        this.analyzer = new polymer_analyzer_1.Analyzer({ urlLoader: new file_map_url_loader_1.FileMapUrlLoader(this.config.root, this.files) });
        this.filePath =
