  ...
  `).trim();
    ...
    check(document) {
        return __awaiter(this, void 0, void 0, function* () {
            const warnings = [];
            const elementLikes = Array.from(document.getByKind('element'))
...
exports.CallSuperInCallbacks = CallSuperInCallbacks;
...
function mustCallSuper(elementLike, methodName, document) {
    ...
    if (elementLike.superClass) {
        const superElement = onlyOrNone(document.getById('element', elementLike.superClass.identifier));
...
function getMethodDefinerFromMixins(elementLike, methodName, document, skipLocalCheck) {
    ...
    for (const mixinReference of elementLike.mixins) {
        ...
        const mixin = onlyOrNone(document.getById('element-mixin', mixinReference.identifier));
