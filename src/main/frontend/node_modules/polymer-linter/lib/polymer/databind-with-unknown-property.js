    ...
    checkDocument(_parsed, document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const domModule of domModules) {
                const elements = document.getById('element', domModule.id, { imported: true, externalPackages: true });
                if (elements.size !== 1) {
                    continue;
                }
...
exports.DatabindWithUnknownProperty = DatabindWithUnknownProperty;
