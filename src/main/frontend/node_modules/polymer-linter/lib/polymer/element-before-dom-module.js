...
class ElementBeforeDomModule extends rule_1.HtmlRule {
    ...
    checkDocument(parsedHtml, document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localElements = Array.from(document.getByKind('polymer-element'))
                .filter((el) => !!el.sourceRange)
                .map((el) => ({ sourceRange: el.sourceRange, elements: [el] }));
            const elementsByImport = Array.from(document.getByKind('import'))
                ...
                // importer.
                const elements = Array.from(i.document.getByKind('polymer-element'));
...
exports.ElementBeforeDomModule = ElementBeforeDomModule;
